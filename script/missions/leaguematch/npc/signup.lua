...
function wlls_want2transback()
	...
	SubWorld = n_oldidx
	if (n_camp) then
		Say("ThÞ vÖ héi tr­êng: ChiÕn ®éi cña b¹n kh«ng ph¶i ®ang thi ®Êu sao? NÕu b©y giê rêi ®éi sÏ kh«ng thÓ l·nh phÇn th­ëng. B¹n nghÜ kü ch­a?",
