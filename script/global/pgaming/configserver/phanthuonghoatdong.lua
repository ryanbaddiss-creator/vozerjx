...
tbAwardTemplet:GiveAwardByList({tbProp = {6,1,122,0,0,0}, nCount = 1}, "PhÛc Duy™n Ti”u", 1);
AddOwnExp(1000000)
end
...
tbAwardTemplet:GiveAwardByList({tbProp = {6,1,123,0,0,0}, nCount = 1}, "PhÛc Duy™n Trung", 1);
