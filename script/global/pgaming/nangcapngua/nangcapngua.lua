	...
	if pg_1 then
		if pg_1 == 1 then
			local _pgTbHORSE = { -- Ngùa cÇn n©ng cÊp
				...
				{pg_1_1 = {0,10,5,7}, pg_1_2 = "XÝch Thè", pg_1_3 = 1, pg_1_4 = 20, pg_1_5 = 20, pg_1_6 = 50, pg_1_7 = 50, pg_1_8 = 5949},
				{pg_1_1 = {0,10,5,8}, pg_1_2 = "TuyÖt ¶nh", pg_1_3 = 1, pg_1_4 = 30, pg_1_5 = 30, pg_1_6 = 50, pg_1_7 = 50, pg_1_8 = 5951},
				{pg_1_1 = {0,10,5,9}, pg_1_2 = "§Ých L«", pg_1_3 = 1, pg_1_4 = 40, pg_1_5 = 40, pg_1_6 = 50, pg_1_7 = 50, pg_1_8 = 5952},
				{pg_1_1 = {0,10,5,10}, pg_1_2 = "ChiÕu D¹ Ngäc S­ Tö", pg_1_3 = 1, pg_1_4 = 50, pg_1_5 = 50, pg_1_6 = 40, pg_1_7 = 50, pg_1_8 = 5948},
				{pg_1_1 = {0,10,8,10}, pg_1_2 = "Phi V©n", pg_1_3 = 1, pg_1_4 = 100, pg_1_5 = 100, pg_1_6 = 40, pg_1_7 = 50, pg_1_8 = 5947},
