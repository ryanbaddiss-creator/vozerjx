...
Say("C¸c h¹ muèn ®æi ThÇn Bİ §å Chİ sang tiÒn v¹n chø? §iÒu kiÖn quy ®æi lµ ph¶i cã trªn 1000 ®å chİ. TØ lÖ quy ®æi 1 ®å chİ = 500 l­îng b¹c",2,
...
Msg2Player("<color=green>B¹n ®· quy ®æi <color=yellow>"..a.." <color> ThÇn Bİ §å Chİ, nhËn vÒ "..(a*500).." l­îng b¹c<color>");
