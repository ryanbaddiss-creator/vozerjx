...
local nDayNow = "20"..nYMD..""
	if (nDayNow >= nTime1) and (nDayNow <= nTime2) then
		...
		Talk(1,"","<color=green>Hoπt ßÈng Di‘n Ra Tı:\n\n <color=red>0h Ngµy 01 - 08 - 20"..nYear.." ß’n 0h Ngµy 01 - 09 - 20"..nYear.."<color><color>")
	end
end				
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function NhanMoc()
	local tbOpt = {
		{"NhÀn Th≠Îng MËc "..nGioiHanMoc1.." Hoµng Kim B∂o Hπp",PhanThuong1},
		{"NhÀn Th≠Îng MËc "..nGioiHanMoc2.." Hoµng Kim B∂o Hπp",PhanThuong2},
		{"NhÀn Th≠Îng MËc "..nGioiHanMoc3.." Hoµng Kim B∂o Hπp",PhanThuong3},
		{"HÒy B·",},
	}
	CreateNewSayEx("<color=green>"..myplayersex().." MuËn NhÀn MËc Nµo<color>\n<color=red>Hi÷n Tπi Ng≠¨i ß∑ Sˆ DÙng <color=yellow>"..GetTask(HOANGKIMBAOHAP).."<color> Hoµng Kim B∂o Hπp<color>", tbOpt)
end	
-----------------------------------------------------Moc 500-------------------------------------------------------------------------------------------------------------------------------------------
