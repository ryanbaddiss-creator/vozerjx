...
function tbVNG_Transport:RandomPos(nCamp)
	...
	if not(tbVNG_Transport.tbPos[nCamp][nWorld]) or not(tbVNG_Transport.tbPos[nCamp][nWorld].tbRandomPos) then
		return Msg2Player("Kh«ng x¸c ®Þnh ®­îc täa ®é, xin thö l¹i")
	end
